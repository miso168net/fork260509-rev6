...
- **wire 契約機器化**：前端 typings 為裁判、contract test＋coverage gate 守恆、13 碼矩陣凍結（憲法 §I.3；機制隨 wire 地基刀落地）。
...
| 契約守恆 | typings 抽 JSON Schema 當裁判；每條 route 必有 contract case | 憲法 §I.3；碼面閘隨 wire 刀進場 |
