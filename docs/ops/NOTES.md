...
- **下一步＝005 role-menu-crud**（刀序＝首刀 brainstorm 定序、各刀範圍由各自 brainstorm 定、可翻）：自階段 0 brainstorm 起手。起手前先處理兩件留帳——①BL-00079（Workflow 看門狗免重掛形）依 user 2026-09-20 答覆於下一個維護批起手前再呈裁 ②004 刀 final holistic review 轉入 BACKLOG 之條目（觸發條件逐條見帳本）。
