...
- **現在＝005 前維護批（七支輕量軌；user 2026-09-21 逐題裁定）**：順序＝`maint-backlog-79`（已收單）→ `-35` → `-42` → `-80-88-94-99` → `-92-97` → `-89-83-85` → `-86-90`；逐支交付查 `docs/generated/MILESTONES.md`。**下一步＝第 2 支 `maint-backlog-35`**（事件帳守衛②④）。
