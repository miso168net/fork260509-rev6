...
| GT-08 | RL-0049 | RULES↔LESSONS 對賬 | rev5:ADR 0024 | docs/ops/RULES.md；docs/ops/LESSONS/*.md | pre-commit | 1 | 未解除：GT-08.lessons-absent | 規則層可無來源、教訓可不指向規則 |
...
| 鍵 | 理由 | 解除謂詞 | 登記日 |
|---|---|---|---|
| GT-08.lessons-absent | 首條 LL 教訓尚未落地 | docs/ops/LESSONS/ 目錄存在（首條 LL 落地） | 2026-09-03 |
