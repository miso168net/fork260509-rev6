...
閘數 12／上限 12（一進一出）。真源兩層：存在＝原始碼 finding 錨形、語意＝docstring GATE 區塊（GT-12 斷言錨形 ⊆ 區塊、三處名冊同源）。Day-1 豁免 3 筆（§4.6；到期即紅）。
...
| GT-10 | RL-0035 | 佔位與樣板文、子項名冊（鍵集＋值↔標題）、圖表對賬 | ADR-00004 | BOOK_FACE（docs/arc42 非 decisions、docs/c4、docs/compliance、docs/process） | pre-commit | 1 | 未解除：GT-10.doc-skeleton-absent | RAD-AI 表可空殼交卷（22/22 假滿分重演） |
