...
│   └── orchestration/               Workflow 編排骨架 _sk_*.js（單一骨架、TDD／review 兩種主流程共用首段；_sk_rules.js＝generate 產物）、assemble.py 組裝器（三道自檢）、harness-test 十二案／harness-review 六案（斷言＋退出碼）、cdp.mjs、EXAMPLE 成品與 review 單元定義範本
