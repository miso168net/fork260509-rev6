...
DAY1_EXEMPTIONS = {
    ...
    "GT-09.hooks-absent": Day1Exemption("GT-09.hooks-absent", ".githooks 於波 1 Task 11 落地", lambda ctx: ctx.exists(PRECOMMIT), "2026-09-03"),
    ...
    "GT-12.precommit-absent": Day1Exemption("GT-12.precommit-absent", "pre-commit 於波 1 Task 11 落地", lambda ctx: ctx.exists(PRECOMMIT), "2026-09-03"),
}
